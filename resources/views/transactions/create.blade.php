                    ...
                    <form method="POST" action="{{ route('transactions.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="input_method" 
                                    ...
                                    class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                    required>
                                <option value="manual" {{ old('input_method', 'manual') === 'manual' ? 'selected' : '' }}>Manual</option>
                                <option value="voice" {{ old('input_method') === 'voice' ? 'selected' : '' }}>Voice</option>
                                <option value="scan" {{ old('input_method') === 'scan' ? 'selected' : '' }}>Scan</option>
                            </select>
                            @error('input_method')
                                <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                            @enderror
