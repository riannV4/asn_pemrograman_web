...
<?php $component->withAttributes(['currentPage' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('profile')]); ?>
    <div class="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5 px-4 py-6 lg:px-8 lg:py-8">
        ...
        <aside class="mb-6 lg:sticky lg:top-8 lg:mb-0 lg:min-h-[calc(100vh-4rem)] rounded-card bg-primary p-[1px] shadow-card-hover">
            ...
            <div class="relative overflow-hidden rounded-card bg-primary p-6 text-white shadow-card">
                ...
                <div class="relative z-10 text-center">
                    ...
                    <p class="text-white/85 text-body-md break-all"><?php echo e($user->email); ?></p>
                </div>
            </div>
        ...
        <div class="bg-surface rounded-card p-2 mb-4 shadow-card lg:p-3">
            <a href="<?php echo e(route('categories.index')); ?>" class="flex items-center justify-between p-4 hover:bg-primary-container/60 rounded-button transition-colors">
...
<?php endif; ?>
<?php /**PATH D:\projekpemro\asn_pemrograman_web\resources\views/profile/edit.blade.php ENDPATH**/ ?>