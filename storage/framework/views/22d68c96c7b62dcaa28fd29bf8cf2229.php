    ...
    <div class="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5 px-4 py-6">
        ...
        <div class="bg-gradient-to-br from-primary to-primary-dark rounded-card p-6 mb-6 relative overflow-hidden shadow-card">
            ...
            <div class="relative z-10 text-center">
                ...
                <h3 class="text-headline-md font-bold text-white mb-1"><?php echo e(Auth::user()->name); ?></h3>
                <p class="text-white/80 text-body-md"><?php echo e(Auth::user()->email); ?></p>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\alfat\OneDrive\Documents\semester 4\prakpemrograman\asn_pemrograman_web\resources\views/profile/edit.blade.php ENDPATH**/ ?>