    ...
    <div class="flex h-screen w-full">
        ...
        <nav class="bg-surface-container-lowest h-screen w-64 border-r border-outline-variant flex flex-col sticky left-0 top-0 overflow-y-auto">
            <div class="p-lg flex items-center gap-md border-b border-outline-variant/50">
                ...
                <div>
                    <h1 class="font-headline-md text-headline-md text-primary"><?php echo e(config('app.name', 'Kostly')); ?></h1>
            ...
            <div class="flex-1 py-md">
                <!-- Dashboard -->
                <a class="<?php echo e(request()->routeIs('dashboard') ? 'bg-secondary-container text-on-secondary-container' : 'text-on-surface-variant hover:bg-surface-container-high'); ?> rounded-xl px-4 py-3 mx-2 my-1 flex items-center gap-3 transition-colors duration-200 active:scale-95" href="<?php echo e(route('dashboard')); ?>">
                    <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">dashboard</span>
                    <span class="font-label-bold text-label-bold">Dashboard</span>
                </a>

                <!-- Transactions -->
                <a class="<?php echo e(request()->routeIs('transactions.*') ? 'bg-secondary-container text-on-secondary-container' : 'text-on-surface-variant hover:bg-surface-container-high'); ?> rounded-xl px-4 py-3 mx-2 my-1 flex items-center gap-3 transition-colors duration-200 active:scale-95" href="<?php echo e(route('transactions.index')); ?>">
                    <span class="material-symbols-outlined">receipt_long</span>
                    <span class="font-label-bold text-label-bold">Transactions</span>
                </a>

                <!-- Reports -->
                <a class="<?php echo e(request()->routeIs('reports') ? 'bg-secondary-container text-on-secondary-container' : 'text-on-surface-variant hover:bg-surface-container-high'); ?> rounded-xl px-4 py-3 mx-2 my-1 flex items-center gap-3 transition-colors duration-200 active:scale-95" href="<?php echo e(route('reports')); ?>">
                    <span class="material-symbols-outlined">bar_chart</span>
                    <span class="font-label-bold text-label-bold">Reports</span>
                </a>

                <!-- Settings -->
                <a class="<?php echo e(request()->routeIs('categories.*') ? 'bg-secondary-container text-on-secondary-container' : 'text-on-surface-variant hover:bg-surface-container-high'); ?> rounded-xl px-4 py-3 mx-2 my-1 flex items-center gap-3 transition-colors duration-200 active:scale-95" href="<?php echo e(route('categories.index')); ?>">
            ...
            <div class="p-md mt-auto border-t border-outline-variant/50">
                <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center gap-md p-sm rounded-xl hover:bg-surface-container-high cursor-pointer transition-colors duration-200">
                    ...
                    <div class="flex-1 overflow-hidden min-w-0">
                        <p class="font-label-bold text-label-bold truncate"><?php echo e(Auth::user()->name); ?></p>
...
<?php /**PATH C:\Users\alfat\Favorites\asn_pemrograman_web\resources\views/components/app-dashboard.blade.php ENDPATH**/ ?>