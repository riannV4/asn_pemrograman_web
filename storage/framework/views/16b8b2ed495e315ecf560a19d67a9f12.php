            ...
            <div id="categoriesList" class="space-y-3 mb-6">
                <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-surface rounded-card p-4 flex items-center gap-4 shadow-card hover:shadow-card-hover transition-all" data-category-id="<?php echo e($category->id); ?>">
                        ...
                        <!-- Delete Button -->
                        <form id="delete-category-<?php echo e($category->id); ?>-form" action="<?php echo e(route('categories.destroy', $category)); ?>" method="POST" class="shrink-0">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="button" @click="$dispatch('open-modal', { id: 'delete-category-<?php echo e($category->id); ?>-modal' })" class="w-10 h-10 rounded-full hover:bg-error-container flex items-center justify-center text-error transition-colors">
        ...
        function addCategoryToList(category) {
            ...
            const categoryHtml = `
                <div class="card-shadow bg-white rounded-[24px] p-4 flex items-center gap-4 hover:scale-[1.02] transition-all" data-category-id="${category.id}">
                    ...
                    <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'delete-category-${category.id}-modal','title' => 'Hapus Kategori?','confirmText' => 'Ya, Hapus','cancelText' => 'Batal','type' => 'delete','categoryName' => '${category.name}','categoryColor' => '${category.color}','categoryIcon' => '${category.icon}']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'delete-category-${category.id}-modal','title' => 'Hapus Kategori?','confirmText' => 'Ya, Hapus','cancelText' => 'Batal','type' => 'delete','categoryName' => '${category.name}','categoryColor' => '${category.color}','categoryIcon' => '${category.icon}']); ?>
                        Kategori ini akan dihapus permanen. Transaksi yang terkait tidak akan terhapus.
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9f64f32e90b9102968f2bc548315018c)): ?>
...
<?php endif; ?>
<?php /**PATH D:\projekpemro\asn_pemrograman_web\resources\views/categories/index.blade.php ENDPATH**/ ?>