...
<body class="font-sans antialiased bg-background text-on-background">
            ...
            <div class="flex items-center gap-4">
                <?php if(Route::has('login')): ?>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="px-4 py-2 bg-primary text-white rounded-lg font-semibold hover:bg-primary-dark transition shadow-sm hover:shadow">Dashboard</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-on-surface hover:text-primary font-semibold transition">Masuk</a>
                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="px-4 py-2 bg-primary text-white rounded-lg font-semibold hover:bg-primary-dark transition shadow-sm hover:shadow">Daftar</a>
                        <?php endif; ?>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
    ...
    <section class="min-h-screen bg-gradient-to-br from-background via-surface to-primary/5 pt-32 px-4 flex items-center">
        <div class="max-w-4xl mx-auto text-center py-12 sm:py-20">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4 px-4">
                <a href="<?php echo e(route('register')); ?>" class="px-8 py-3 sm:py-4 bg-primary text-white rounded-xl font-semibold hover:bg-primary-dark transition-all duration-200 shadow-lg hover:shadow-xl">
                    Mulai Gratis
                </a>
    ...
    <section class="bg-gradient-to-r from-primary to-primary-dark py-16 sm:py-20 px-4">
        <div class="max-w-3xl mx-auto text-center text-white">
            ...
            <a href="<?php echo e(route('register')); ?>" class="px-8 py-3 bg-white text-primary rounded-xl font-bold hover:bg-surface transition-colors inline-block">
                Daftar Sekarang →
            </a>
        </div>
    </section>
    ...
    <footer class="bg-on-background/5 py-8 px-4 border-t border-outline-variant">
        <div class="max-w-7xl mx-auto text-center">
            ...
            <p class="text-on-surface-variant text-sm">
                © <?php echo e(date('Y')); ?> Kostly. Kelola uang kost dengan mudah dan percaya diri.
            </p>
        </div>
    </footer>
</body>
</html>
<?php /**PATH D:\clone_git\asn_pemrograman_web\resources\views/welcome.blade.php ENDPATH**/ ?>