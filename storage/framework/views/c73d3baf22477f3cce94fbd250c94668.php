            ...
            <div class="flex items-center gap-4">
                <?php if(Route::has('login')): ?>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="text-on-surface hover:text-primary font-medium transition">Dashboard</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-on-surface hover:text-primary font-medium transition">Masuk</a>
                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="px-4 py-2 bg-primary text-white rounded-lg font-medium hover:bg-primary-dark transition">Daftar</a>
                        <?php endif; ?>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
