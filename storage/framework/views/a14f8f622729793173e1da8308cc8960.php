...
<body class="bg-surface text-on-surface flex h-screen overflow-hidden antialiased">
    ...
    <aside class="flex flex-col h-full sticky left-0 top-0 overflow-y-auto bg-surface-container-lowest dark:bg-surface-container-low h-screen w-64 border-r border-outline-variant hidden md:flex z-50">
        <div class="p-6">
            ...
            <nav class="space-y-1">
                <a class="text-on-surface-variant dark:text-outline-variant hover:bg-surface-container-high dark:hover:bg-surface-container rounded-xl px-4 py-3 mx-2 my-1 flex items-center gap-3 transition-colors duration-200" href="<?php echo e(route('dashboard')); ?>">
                    <span class="material-symbols-outlined">dashboard</span>
                    <span class="font-body-md text-body-md font-semibold">Dashboard</span>
                </a>
                <a class="text-on-surface-variant dark:text-outline-variant hover:bg-surface-container-high dark:hover:bg-surface-container rounded-xl px-4 py-3 mx-2 my-1 flex items-center gap-3 transition-colors duration-200" href="<?php echo e(route('transactions.index')); ?>">
                    <span class="material-symbols-outlined">receipt_long</span>
                    <span class="font-body-md text-body-md font-semibold">Transactions</span>
                </a>
                <a class="bg-secondary-container dark:bg-on-secondary-fixed-variant text-on-secondary-container dark:text-secondary-fixed rounded-xl px-4 py-3 mx-2 my-1 flex items-center gap-3 transition-transform active:scale-95 font-bold" href="<?php echo e(route('reports')); ?>">
                    <span class="material-symbols-outlined fill">bar_chart</span>
                    <span class="font-body-md text-body-md">Reports</span>
                </a>
                <a class="text-on-surface-variant dark:text-outline-variant hover:bg-surface-container-high dark:hover:bg-surface-container rounded-xl px-4 py-3 mx-2 my-1 flex items-center gap-3 transition-colors duration-200" href="<?php echo e(route('profile.edit')); ?>">
        ...
        <div class="mt-auto p-6 border-t border-outline-variant">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="font-label-bold text-label-bold text-on-surface max-w-[110px] truncate" title="<?php echo e(Auth::user()->name); ?>"><?php echo e(Auth::user()->name); ?></p>
                        <p class="font-body-md text-[10px] text-on-surface-variant truncate max-w-[110px]"><?php echo e(Auth::user()->email); ?></p>
                    </div>
                </div>
            ...
            <div class="max-w-7xl mx-auto space-y-lg">
                ...
                <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div>
                        <div class="flex items-center gap-2">
                            ...
                            <div class="flex items-center gap-1 bg-surface-container-low px-2 py-0.5 rounded-lg border border-outline-variant/30 text-xs">
                                ...
                                <span class="font-semibold text-on-surface text-[11px]"><?php echo e($monthDisplay); ?></span>
                            </div>
                        </div>
                    ...
                    <div class="flex bg-surface-container-low rounded-xl p-1 border border-outline-variant/30">
                        <form method="GET" action="<?php echo e(route('reports')); ?>" class="inline">
                            <input type="hidden" name="filter" value="weekly">
                            <button type="submit" class="px-4 py-2 rounded-lg font-body-md text-body-md transition-all duration-200 <?php echo e($filterType === 'weekly' ? 'bg-white card-shadow font-bold text-primary' : 'font-semibold text-on-surface-variant hover:text-primary'); ?>">
                                Mingguan
                            </button>
                        </form>
                        <form method="GET" action="<?php echo e(route('reports')); ?>" class="inline">
                            <input type="hidden" name="filter" value="monthly">
                            <button type="submit" class="px-4 py-2 rounded-lg font-body-md text-body-md transition-all duration-200 <?php echo e($filterType === 'monthly' ? 'bg-white card-shadow font-bold text-primary' : 'font-semibold text-on-surface-variant hover:text-primary'); ?>">
                                Bulanan
                            </button>
                        </form>
                        <button type="button" onclick="toggleCustomDate()" class="px-4 py-2 rounded-lg font-body-md text-body-md transition-all duration-200 <?php echo e($filterType === 'custom' ? 'bg-white card-shadow font-bold text-primary' : 'font-semibold text-on-surface-variant hover:text-primary'); ?>">
                            Kustom
                        </button>
                    </div>
                </div>
                ...
                <div id="custom-date-range" class="<?php echo e($filterType === 'custom' ? '' : 'hidden'); ?> p-4 bg-white rounded-xl card-shadow border border-outline-variant/10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
                    ...
                    <div class="bg-white rounded-xl p-4 lg:p-6 card-shadow border border-outline-variant/10 flex items-center gap-4">
                        ...
                        <div>
                            <p class="font-body-md text-body-md text-on-surface-variant">Pemasukan (<?php echo e($monthDisplay); ?>)</p>
                            <p class="font-display-currency text-display-currency text-on-surface">Rp <?php echo e(number_format($totalIncome, 0, ',', '.')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-4 lg:p-6 card-shadow border border-outline-variant/10 flex items-center gap-4">
                        ...
                        <div>
                            <p class="font-body-md text-body-md text-on-surface-variant">Pengeluaran (<?php echo e($monthDisplay); ?>)</p>
                            <p class="font-display-currency text-display-currency text-error">- Rp <?php echo e(number_format($totalExpense, 0, ',', '.')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="bg-primary rounded-xl p-4 lg:p-6 card-shadow flex items-center gap-4 text-on-primary relative overflow-hidden">
                        ...
                        <div class="z-10">
                            ...
                            <p class="font-display-currency text-display-currency text-white">
                                <?php echo e($balance >= 0 ? 'Rp ' . number_format($balance, 0, ',', '.') : '- Rp ' . number_format(abs($balance), 0, ',', '.')); ?>
                            ...
                            <?php if($totalPie > 0): ?>
                                <?php $__currentLoopData = $pieChartData['labels']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="flex items-center justify-between font-body-md text-body-md">
                                        <div class="flex items-center gap-2">
                                            <div class="w-3 h-3 rounded-full" style="background-color: <?php echo e($color); ?>"></div>
                                            <span class="text-on-surface-variant max-w-[130px] truncate" title="<?php echo e($label); ?>"><?php echo e($label); ?></span>
                                        </div>
                                        <span class="font-semibold text-on-surface"><?php echo e($percentage); ?>%</span>
                                    </div>
                ...
                <div class="bg-white rounded-xl p-4 lg:p-6 card-shadow border border-outline-variant/10">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="<?php echo e(route('transactions.index')); ?>" class="text-primary hover:underline text-sm font-semibold flex items-center gap-1">
                                    ...
                                    <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-surface-container-low/30 transition-colors duration-150">
                                            ...
                                            <td class="py-4 px-4 whitespace-nowrap text-on-surface-variant">
                                                <?php echo e($transaction->category ? $transaction->category->name : 'Tanpa Kategori'); ?>
                                            ...
                                            <td class="py-4 px-4 whitespace-nowrap text-right font-semibold <?php echo e($transaction->type === 'income' ? 'text-primary' : 'text-error'); ?>">
                                                <?php echo e($transaction->type === 'income' ? '+' : '-'); ?> Rp <?php echo e(number_format($transaction->amount, 0, ',', '.')); ?>

                                            </td>
                                            <td class="py-4 pl-4 max-w-xs truncate text-on-surface-variant" title="<?php echo e($transaction->notes); ?>">
    ...
    <nav class="fixed bottom-0 w-full z-50 items-center px-4 py-2 bg-surface dark:bg-surface-container-low border-t border-outline-variant shadow-[0_-4px_12px_rgba(15,23,42,0.05)] md:hidden rounded-t-xl grid grid-cols-4">
        <a class="flex flex-col items-center justify-center text-on-surface-variant hover:bg-surface-container-high transition-colors h-14 rounded-lg w-full" href="<?php echo e(route('dashboard')); ?>">
            <span class="material-symbols-outlined">home</span>
            <span class="font-label-bold text-[10px] mt-1">Beranda</span>
        </a>
        <a class="flex flex-col items-center justify-center text-on-surface-variant hover:bg-surface-container-high transition-colors h-14 rounded-lg w-full" href="<?php echo e(route('transactions.index')); ?>">
            <span class="material-symbols-outlined">account_balance_wallet</span>
            <span class="font-label-bold text-[10px] mt-1">Transaksi</span>
        </a>
        <a class="flex flex-col items-center justify-center text-primary bg-secondary-container rounded-lg w-full h-14 hover:bg-surface-container-high transition-colors active:scale-95 font-bold" href="<?php echo e(route('reports')); ?>">
            <span class="material-symbols-outlined fill">analytics</span>
            <span class="font-label-bold text-[10px] mt-1">Laporan</span>
        </a>
        <a class="flex flex-col items-center justify-center text-on-surface-variant hover:bg-surface-container-high transition-colors h-14 rounded-lg w-full" href="<?php echo e(route('profile.edit')); ?>">
            <span class="material-symbols-outlined">settings</span>
            ...
            new Chart(donutCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: <?php echo json_encode($pieChartData['colors'], 15, 512) ?>,
                        borderWidth: 0,
                        hoverOffset: 4
                    }]
                },
        ...
        new Chart(barCtx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Pemasukan',
                        data: <?php echo json_encode($barChartData['income'], 15, 512) ?>,
                    ...
                    {
                        label: 'Pengeluaran',
                        data: <?php echo json_encode($barChartData['expense'], 15, 512) ?>,
...
<?php /**PATH D:\projekpemro\asn_pemrograman_web\resources\views/reports.blade.php ENDPATH**/ ?>